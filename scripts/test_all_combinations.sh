...
FEATURES=("extended_fonts" "opendyslexic_fonts" "image_sleep" "markdown" "integrations" "koreader_sync" "calibre_sync" "background_server" "home_media_picker" "web_pokedex_plugin" "epub_support" "hyphenation" "xtc_support" "lyra_theme" "ota_updates" "todo_planner" "dark_mode" "visual_cover_picker")
TOTAL=$((2 ** ${#FEATURES[@]}))
FAILED=0
PASSED=0
