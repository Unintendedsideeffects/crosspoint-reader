...
constexpr uint8_t SORTED_LANGUAGE_INDICES[] = {
    ...
    static_cast<uint8_t>(Language::IT),         static_cast<uint8_t>(Language::PL),
    static_cast<uint8_t>(Language::PORTUGUESE), static_cast<uint8_t>(Language::RO),
    static_cast<uint8_t>(Language::RUSSIAN),    static_cast<uint8_t>(Language::SPANISH),
    static_cast<uint8_t>(Language::SWEDISH),    static_cast<uint8_t>(Language::UK)};
