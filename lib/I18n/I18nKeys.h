...
// Order: English, Беларуская, Català, Čeština, Dansk, Suomi, Français, Deutsch, Italiano, Nederlands, Polski, Português (Brasil), Română, Русский, Español, Svenska, Українська
constexpr uint8_t SORTED_LANGUAGE_INDICES[] = {static_cast<uint8_t>(Language::EN), static_cast<uint8_t>(Language::BE), static_cast<uint8_t>(Language::CA), static_cast<uint8_t>(Language::CZECH), static_cast<uint8_t>(Language::DA), static_cast<uint8_t>(Language::FI), static_cast<uint8_t>(Language::FRENCH), static_cast<uint8_t>(Language::GERMAN), static_cast<uint8_t>(Language::IT), static_cast<uint8_t>(Language::NL), static_cast<uint8_t>(Language::PL), static_cast<uint8_t>(Language::PORTUGUESE), static_cast<uint8_t>(Language::RO), static_cast<uint8_t>(Language::RUSSIAN), static_cast<uint8_t>(Language::SPANISH), static_cast<uint8_t>(Language::SWEDISH), static_cast<uint8_t>(Language::UK)};
// clang-format on
